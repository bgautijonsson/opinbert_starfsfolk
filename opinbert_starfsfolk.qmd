...
ggsave(plot = p, filename = "hlutfall_af_vinnuafli.pdf", 
...
ggsave(plot = p, filename = "fjoldi_rangt.pdf", 
       width = 8, height = 0.5 * 8, scale = 1)
```
...
ggsave(plot = p, filename = "fjoldi_saman.pdf", 
       width = 8, height = 0.5 * 8, scale = 1)
```
...
ggsave(plot = p, filename = "fjoldi_rett.pdf", 
       width = 8, height = 0.5 * 8, scale = 1)
```
...
ggsave(plot = p, filename = "fjoldi_alls.pdf", 
       width = 8, height = 0.5 * 8, scale = 1)
```
